        ...
        <div class="col">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{ url('/livros/editar', ['id' => $livro['id']]) }}">Editar</a>
                        <a onclick="confirma(this)" href="{{ url('/livros/delete', ['id' => $livro['id']]) }}" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Excluir</a>
